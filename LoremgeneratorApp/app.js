...
form.addEventListener('submit', function(e){
	e.preventDefault();
	// console.log("hello");
	// amount is an input and return string
	// const value = amount.value;

	// for returning int need to put parseInt() method
	const value = parseInt(amount.value);
	//all inputs return string, need to transform into number
	// console.log(value);
	// show if is string or number
